...
ftp_command_t ftp_commands[] = {
    ...
    FTP_COMMAND(RNTO),     FTP_COMMAND(SITE),    FTP_COMMAND(SIZE),
    FTP_COMMAND(STAT),     FTP_COMMAND(STOR),    FTP_COMMAND(STOU),
    FTP_COMMAND(STRU),     FTP_COMMAND(SYST),    FTP_COMMAND(TYPE),
    FTP_COMMAND(USER),
